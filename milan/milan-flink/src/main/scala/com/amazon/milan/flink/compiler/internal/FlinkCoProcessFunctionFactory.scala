...
object FlinkCoProcessFunctionFactory {
  ...
  def getFullJoinCoProcessFunction[TLeft, TRight, TOut](mapExpr: MapNodeExpression,
    ...
    val leftInputType = joinExpr.left.recordType.asInstanceOf[TypeDescriptor[TLeft]]
    val rightInputType = joinExpr.right.recordType.asInstanceOf[TypeDescriptor[TRight]]
