...
import com.amazon.milan.flink.runtime.RecordIdExtractor
...
trait RecordIdExtractorGenerator {
   ...
   * @return The name of the class that implements the [[com.amazon.milan.flink.runtime.RecordIdExtractor]].
   */
