...
import com.amazon.milan.flink.internal.AggregateFunctionTreeExtractor
import com.amazon.milan.flink.runtime.{BuiltinAggregateFunctions, _}
...
trait AggregateFunctionGenerator extends FunctionGenerator {
   ...
   */
  private def generateAggregateFunctionForExpression(env: GeneratorOutputs,
    ...
    env.addImport(com.amazon.milan.flink.runtime.implicits.packageName + "._")
    ...
    val mapInputDef = env.scalaGenerator.getScalaFunctionDef("mapInput", inputMappingFunctionDef)

    val className = env.newClassName(s"AggregateFunction_${streamIdentifier}_${aggregateExpression.expressionType}_")
