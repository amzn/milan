...
class IntRecord(var recordId: String, var i: Int) extends Comparable[IntRecord] with Serializable {
  def this(i: Int) {
    this(Id.newId(), i)
  }
  ...
  override def toString: String = s"IntRecord(${this.i})"
}
...
class StringRecord(val recordId: String, val s: String) extends Serializable {
  def this(s: String) {
    this(Id.newId(), s)
  }
  ...
  override def toString: String = s"StringRecord(${this.s})"
}
...
class KeyValueRecord(var recordId: String, var key: String, var value: String) extends Serializable {
  def this() {
    this(Id.newId(), "", "")
  }
...
class TwoIntRecord(val recordId: String, val a: Int, val b: Int) extends Serializable {
...
object IntLongRecord {
  def apply(a: Int, b: Long): IntLongRecord = new IntLongRecord(a, b)
}

class IntLongRecord(val recordId: String, val a: Int, val b: Long) extends Serializable {
  def this(a: Int, b: Long) {
    this(Id.newId(), a, b)
  }

  override def equals(obj: Any): Boolean = obj match {
    case o: IntLongRecord => this.a == o.a && this.b == o.b
    case _ => false
  }
}
...
class NumbersRecord(val recordId: String, val i1: Int, val i2: Int, val d1: Double, val d2: Double, val f1: Float) extends Serializable

object IntKeyValueRecord {
  def apply(key: Int, value: Int): IntKeyValueRecord = new IntKeyValueRecord(key, value)
}

class IntKeyValueRecord(var recordId: String, var key: Int, var value: Int) extends Serializable {
  def this() {
    this(Id.newId(), 0, 0)
  }
...
class IntStringRecord(val recordId: String, val i: Int, val s: String) extends Serializable {
...
class DateIntRecord(val recordId: String, val dateTime: Instant, val i: Int) extends Serializable {
...
class DateKeyValueRecord(val recordId: String, val dateTime: Instant, val key: Int, val value: Int) extends Serializable {
  override def equals(obj: Any): Boolean = obj match {
...
class Tuple3Record[T1, T2, T3](var recordId: String, var f0: T1, var f1: T2, var f2: T3) extends Serializable {
  ...
  override def toString: String = s"(${this.f0}, ${this.f1}, ${this.f2})"
}
...
class Tuple4Record[T1, T2, T3, T4](var recordId: String, var f0: T1, var f1: T2, var f2: T3, var f3: T4) extends Serializable {
  ...
  override def toString: String = s"(${this.f0}, ${this.f1}, ${this.f2}, ${this.f3})"
}
