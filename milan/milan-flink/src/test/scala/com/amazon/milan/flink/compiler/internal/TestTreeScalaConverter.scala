...
class TestTreeScalaConverter {
  ...
  def test_TreeScalaConverter_WithTwoObjectInputs_ReturnsExpectedCode(): Unit = {
    ...
    val expectedCode = "(a: com.amazon.milan.flink.testutil.IntRecord, b: com.amazon.milan.flink.testutil.IntRecord) => FakeType.fakeFunction(a.i, b.i)"
  ...
  def test_TreeScalaConverter_WithOneObjectAndOneTupleInput_ReturnsExpectedCode(): Unit = {
    ...
    val code = TreeScalaConverter.getScalaAnonymousFunction(tree, List(input1, input2))
    val expectedCode = "(a: com.amazon.milan.flink.testutil.IntRecord, b: com.amazon.milan.flink.types.ArrayRecord) => FakeType.fakeFunction(a.i, b(1).asInstanceOf[String])"
    assertEquals(expectedCode, code)
  }
  ...
  def test_TreeScalaConverter_WithCreateInstance_ReturnsExpectedCode(): Unit = {
    ...
    val expectedCode = "(r: com.amazon.milan.flink.testutil.IntRecord) => new com.amazon.milan.flink.testutil.IntRecord(r.recordId, r.i)"
    assertEquals(expectedCode, code)
  }
