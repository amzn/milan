...
import com.amazon.milan.serialization.{JsonDeserializationSchema, JsonSerializationSchema}
...
object ControllerFlinkApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val packageRepoUri = new AmazonS3URI(params.packageRepositoryS3Location)
    val packageRepository = PackageRepository.createS3PackageRepository(packageRepoUri)
