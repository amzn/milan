...
object RecordWithLineageSerializer {
  ...
  class ConfigSnapshot[T <: Record](val recordConfigSnapshot: TypeSerializerSnapshot[T],
...
class RecordWithLineageSerializer[T <: Record](val recordSerializer: TypeSerializer[T],
