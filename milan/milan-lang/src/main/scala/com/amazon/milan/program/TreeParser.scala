  ...
  private def convertNode[T](node: ParseNode): T = {
    ...
    val converted =
      name match {
        ...
        case "FunctionDef" => FunctionDef(convertList[ValueDef](children(0)), convertNode[Tree](children(1)))
        ...
        case "GreaterThanOrEqual" => GreaterThanOrEqual(convertNode[Tree](children(0)), convertNode[Tree](children(1)))
        ...
        case "LessThanOrEqual" => LessThanOrEqual(convertNode[Tree](children(0)), convertNode[Tree](children(1)))
        ...
        case "SelectField" => SelectField(convertNode[Tree](children(0)), getString(children(1)))
        case "Tuple" => Tuple(convertList[Tree](children.head))
        case "TupleElement" => TupleElement(convertNode[Tree](children(0)), getValue(children(1), types.Int).asInstanceOf[Int])
        ...
        case "ValueDef" => ValueDef.named(getString(children(0)))

        // Stream expressions
        case "Filter" => Filter(convertNode[StreamExpression](children(0)), convertNode[FunctionDef](children(1)))
        case "FlatMap" => FlatMap(convertNode[Tree](children(0)), convertNode[FunctionDef](children(1)))
